...
from .api import UserViewSet, LabelList, ProjectStatsAPI, ProjectProgressAPI, LabelDetail, DocumentDetail, ProjectDetails, ProjectList, UserInfo, \
...
urlpatterns = [
    ...
    path('api/projects/<int:project_id>/progress/', ProjectProgressAPI.as_view(), name='progress-api'),
